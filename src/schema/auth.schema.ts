...
export const registerSchema = z.object({
  ...
  password: z
    ...
    .min(8, 'minimum password must have 8 character')
    .max(12, 'maximum password must have 12 character'),
...
export type RegisterAuthGooglePayload = Omit<RegisterPayload, 'password'>
